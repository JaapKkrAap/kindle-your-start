...
const CATEGORY_COLORS: Record<MemoryCategory, string> = {
    ...
    kink: 'bg-fuchsia-500/15 text-fuchsia-300 border-fuchsia-500/30',
    promise: 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30',
    secret: 'bg-amber-500/15 text-amber-300 border-amber-500/30',
    favorite: 'bg-pink-500/15 text-pink-300 border-pink-500/30',
};
